...
class NearestClinicsWidget extends StatelessWidget {
  const NearestClinicsWidget({super.key});
    ...
    return Consumer<DashboardProvider>(
      ...
      return SizedBox(
        ...
        child: ListView.builder(
            itemCount:
                dashboardProvider.dashboardInfoData?.nearestClinics.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: (context, index) {
              final clinic =
                  dashboardProvider.dashboardInfoData?.nearestClinics[index];
              return Padding(
                        ...
                        children: [
                          Expanded(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                text: "${clinic?.relationships.state}",
                                maxLines: 1,
                              )),
                            ],
                          )),
                          ...
                          Row(
                            children: [
                              ...
                              BodyTextPrimaryWithLineHeight(
                                text:
                                    "${clinic?.relationships.reviews.totalReviewsCount}",
                                fontSize: 12,
