    ...
    return Consumer<DashboardProvider>(
      ...
      return SizedBox(
        ...
        child: ListView.builder(
            itemCount:
                dashboardProvider.dashboardInfoData?.canineAroundYou.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: (context, index) {
              final canine =
                  dashboardProvider.dashboardInfoData?.canineAroundYou[index];
              return Padding(
                padding: EdgeInsets.only(
                    left: index == 0 ? horizontalPadding.w : 0, right: 12),
                child: InkWell(
                  onTap: () {
                    dashboardProvider.updateSelectedCanineOfTheDay(canine);
                    navToWithScreenName(
                        context: context,
