...
Future showCitySelectionModal(BuildContext importedContext) {
          ...
          child:
            ...
            return Column(
              ...
              children: [
                ...
                canineProvider.gettingCities
                    ? Padding(
                        padding: EdgeInsets.only(bottom: bottomPadding.h),
                        child: const CupertinoActivityIndicator(),
                      )
                    : canineProvider.citiesList.isEmpty
                        ? Padding(
                            padding: EdgeInsets.only(bottom: bottomPadding.h),
                        ...
                        : Container(
                            ...
                            child: ListView.builder(
                                itemCount: canineProvider.citiesList.length,
                                itemBuilder: (context, index) {
                                  final city = canineProvider.citiesList[index];
                                  return Padding(
