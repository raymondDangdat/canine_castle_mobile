...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  String url = "https://www.caninecastle.comg.ng";
  double progress = 0;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      url = walletProvider.initializePaymentModel?.data.url ?? "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(child: Consumer2<InAppBrowserProvider, WalletProvider>(
            builder: (ctx, inAppBrowserProvider, walletProvider, child) {
                ...
                children: [
                  InAppWebView(
                    ...
                    initialUrlRequest: URLRequest(
                        url: WebUri(
                            walletProvider.initializePaymentModel!.data.url)),
                    ...
                    onLoadStart: (controller, url) async {
                      ...
                      setState(() {
                        ...
                        if (url.toString().toLowerCase().contains("?trxref")) {
