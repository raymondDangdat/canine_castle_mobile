...
const city = "City";
const vetRole = "vet";
const manageCanines = 'Manage Canines';
const favorite = "Favorites";
const crossDeals1 = "Cross deals 1";
const crossDeals2Optional = "Cross deals 2 (optional)";
const notifications = "Notifications";
const customerSupport = "Customer support";
const isThisCanineAPedigree = "Is this canine a pedigree";
const myCanines = "My Canines";
const makeCanineProfilePublic = "Make canine profile public";
const nameOfCanine = "Name of canine";
const addCanine = "Add canine";
